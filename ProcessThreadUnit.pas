...
// ќсновна€ операци€ преобразовани€ данных исходного документа с сохранением результата в другой файл
procedure TProcessThread.Execute;
begin
  inherited;

// раскомментировать FakeExecute только дл€ тестировани€ (при этом RealExecute должен быть закомментирован)
//  FakeExecute;
...
// ћетод-заглушка дл€ отработки взаимодействи€ главного потока программы с текущим потоком
    ...
    on Exception do
      Begin
        try
          ...
          on Exception do
            Begin
              raise Exception.create('Ќе удаетс€ открыть Microsoft Excel!'#13'¬озможно он не установлен.');
            End;
        end;
      End;
  End;
